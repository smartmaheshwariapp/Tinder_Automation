    ...
    <View style={styles.container}>
      ...
      {toastMessage && (
        ...
        >
          ...
          <Ionicons name="close" size={14} color="#A7F3D0" style={{ marginLeft: 'auto' }} />
        </TouchableOpacity>
      )}
                          ...
                          >
                            {pushing ? (
                              ...
                              <Text style={styles.genActionPushText}>
                                ↓ Push Bio to {bioMode === 'bumble' ? 'Bumble' : 'Tinder'}
                              </Text>
                            )}
                          </TouchableOpacity>
      ...
      {/* ─── Desktop V2 Animated Save Bar (Spring Pop-Up & Progress Shrink) ─── */}
      <Animated.View
        style={[
          styles.saveBar,
          {
        ...
        pointerEvents={saveBarVisible ? 'auto' : 'none'}
      >
        {/* 5-second Progress Line matching Desktop V2 progressShrink */}
        <Animated.View
          style={[
