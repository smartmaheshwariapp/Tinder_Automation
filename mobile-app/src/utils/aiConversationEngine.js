...
export async function fetchLiveAiChatReply({
  ...
  try {
    ...
    const systemPrompt = `You are Flint, an elite modern dating wingman texting on Tinder in ${country}.
...
- Reply directly to the match's last message.`;
    ...
    const userPrompt = `Match says: "${incomingMessage}". Write Flint's outgoing charming reply:`;
