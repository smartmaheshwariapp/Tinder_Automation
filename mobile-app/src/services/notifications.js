...
let _notificationInbox = [
  {
    ...
    type: 'goal_unlocked',
    title: 'Phone Number Received',
    body: 'Jessica shared her contact number (+1 201-555-0192). Automation goal achieved.',
  ...
  },
  {
    ...
    body: 'New match detected on Tinder. AI intro message sent.',
  ...
  },
  {
    ...
    body: '42 likes sent, 3 new matches found. Next cycle scheduled in 30m.',
